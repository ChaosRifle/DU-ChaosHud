# Assembler originally written by DeadRank for his huds at https://github.com/Deadrank/DeadRank-DU
# Minor modifications by Chaos to change source control format and naming. Currently doesnt support copying files automatically on linux.
...
src = args.source[0]
path = os.path.join(cwd,'src',src)

# Mapping of Folders to .conf files
confMap = {
    'ChaosFighter':'ChaosHUDFighter.conf',
    'ChaosHudPilot':'ChaosHUDPilot.conf',
    'ChaosGunner':'ChaosHUDGunner.conf',
}
